...
namespace RxTickets.Service.Controllers
{
    public class TicketsController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/tickets/timestamp")]
        public DateTime Timestamp()
        {
            var timestamp = this._repository.GetTimestamp();
            return timestamp;
        }
        ...
        // POST api/tickets
        public int Post(TicketDetails newTicket)
        {
            var ticketId = this._repository.CreateNewTicket(newTicket);
            return ticketId;
        }
