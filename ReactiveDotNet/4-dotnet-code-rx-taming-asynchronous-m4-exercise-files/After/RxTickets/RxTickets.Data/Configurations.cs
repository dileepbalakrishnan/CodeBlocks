...
namespace RxTickets.Data
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.20.0.0")]
    public class TimestampRowConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TimestampRow>
    {
        public TimestampRowConfiguration()
            : this("dbo")
        {
        }

        public TimestampRowConfiguration(string schema)
        {
            ToTable(schema + ".Timestamp");
            HasKey(x => x.ID);
            Property(x => x.LastModified).HasColumnName(@"LastModified").IsOptional().HasColumnType("datetime");
        }
    }
}
